            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active"> Chính sách giao hàng & vận chuyển</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="col-12">
                        <div class="section-content m-b-60 text-center">
                            <h5 class="section-content__title">Chính sách giao hàng & vận chuyển</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="privacy-policy-section">
                        <div class="text-area">
                            ...
                            <div class="para__text">
                                ...
                                <p style="font-size: large;">Để đảm bảo chất lượng dịch vụ và hàng hoá, đơn hàng sẽ được giao từ 2 - 3 tiếng sau khi chúng tôi tiếp nhận thông tin đặt hàng từ quý khách. Những đơn hàng đặt sau 16:30 sẽ được giao vào ngày hôm sau;</p>
                            </div>
                        </div>
                        <div class="text-area">
                            <h6 class="font--bold" style="font-size: large;">Mặc dù có nhiều phương thức vận chuyển khác nhau nhưng để thống nhất thì Gsora Organic Food lựa chọn phương thức giao hàng đồng giá <b><i>35.000 VNĐ</b></i></h6>
                            <div class="para__text">
                                <p style="font-size: large;">- Tiết kiệm cho những đơn hàng có khoảng cách vận chuyển xa. </p>
                                <p style="font-size: large;">- Đơn hàng được giao hỏa tốc luôn trong ngày.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
1
Đang hiển thị 3266433314391219980.