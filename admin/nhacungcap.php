            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách Nhà cung cấp | <a href="ncc_them_moi.php">Thêm mới</a>
                            </div>
                            <div class="card-body">
                ...
                ;?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["sdtnhacungcap"];?></td>
                                            <td><a href="ncc_sua.php?id=<?php echo $row["manhacungcap"];?>">Sửa</a></td>
                                            <td><a href="ncc_xoa.php?id=<?php echo $row["manhacungcap"];?>">Xóa</a></td>
                                        </tr>
                <?php
                  }
                ;?>
