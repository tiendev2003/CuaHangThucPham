        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Quản trị loại sản phẩm</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Danh sách loại sản phẩm | <a href="loaisanphamthemmoi.php">Thêm mới</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($loai_san_pham)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="loaisanphamsua.php?id=<?php echo $row["maloaisanpham"]; ?>">Sửa</a></td>
                                            <td><a href="loaisanphamxoa.php?id=<?php echo $row["maloaisanpham"]; ?>">Xóa</a></td>
                                        </tr>
                                    <?php
                                    }; ?>
                                </tbody>
