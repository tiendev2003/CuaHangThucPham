                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="sanphamthemmoithuchien.php" enctype="multipart/form-data">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" placeholder="Số Lượng" name="txtSoLuong" id="txtSoLuong"/>                                              
                                                <label for="txtSoLuong">Số Lượng</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                 <input class="form-control" placeholder="Đơn Giá" name="txtDonGia" id="txtDonGia"/>                                              
                                                <label for="txtDonGia">Đơn Giá</label>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                 <input class="form-control" placeholder="Ảnh"  type="file" name="txtAnh" id="txtAnh"/>                                              
                                                <label for="txtAnh">Ảnh</label>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                 <input class="form-control" placeholder="Mô Tả" name="txtMoTa" id="txtMoTa"/>                                              
                                            ...
                                            <div class="form-floating mb-3">                                               
                                                <tr>
                                                    ...
                                                    <td><select name="txtMaNhaCungCap">
                                                        <?php 
                                                        include("../config.php");
                                                        $sql = "SELECT * 
                                                                FROM nhacungcap 
