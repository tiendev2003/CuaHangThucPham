                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cập nhật nhà cung cấp</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="ncc_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTenncc" name="txtTenncc" placeholder="Tên nhà cung cấp" value="<?php echo $row["tennhacungcap"];?>"/>
                                                <label for="txtTenncc">Tên nhà cung cấp</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtSdt" name="txtSdt" placeholder="Số điện thoại" value="<?php echo $row["sdtnhacungcap"];?>"/>
                                                <label for="txtSdt">Số điện thoại</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtDiachi" name="txtDiachi" placeholder="Địa chỉ"><?php echo $row["diachinhacungcap"];?></textarea>
                                                <label for="txtDiachi">Địa chỉ</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["manhacungcap"];?>">
