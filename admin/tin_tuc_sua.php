...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/opilvmcccz7z0ve5t2zrvmttdc1ihcfw7yr8uyho83qsh256/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="tin_tuc_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTieuDe" name="txtTieuDe" placeholder="Tiêu đề" value="<?php echo $row["tieude"]; ?>" />
                                                <label for="txtTieuDe">Tiêu đề</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtAnhMinhHoa" name="txtAnhMinhHoa" type="file" placeholder="Ảnh minh họa" value="<?php echo $row["anhminhhoa"]; ?>" />
                                                <label for="txtAnhMinhHoa">Ảnh minh họa</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtMoTa" name="txtMoTa" placeholder="Mô tả"><?php echo $row["mota"]; ?></textarea>
                                                <label for="txtMoTa">Mô tả</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtNoiDung" name="txtNoiDung" placeholder="Nội dung"><?php echo $row["noidungtintuc"]; ?></textarea>
                                                <label for="txtNoiDung">Nội dung</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["matintuc"]; ?>">
