                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Thêm khuyến mãi</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="khuyenmaithemmoithuchien.php" enctype="multipart/form-data">                                           
                                            <div class="form-floating mb-3">
                                                <input class="form-control" placeholder="Giảm giá"  type="text" name="txtGiamGia" id="txtGiamGia"/>                                              
                                                <label for="txtGiamGia">Giảm giá</label>
                                            </div> 
                                            <div class="form-floating mb-3">
                                                <input class="form-control" placeholder="Thời hạn"  type="text" name="txtThoiHan" id="txtThoiHan"/>                                              
