                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="nhanvien_them_moi_thuc_hien.php" enctype="multipart/form-data">

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTennv" name="txtTennv" placeholder="Tên nhân viên" />
                                                <label for="txtTennv">Tên nhân viên</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtGioitinh" name="txtGioitinh" placeholder="Giới tính" />
                                                <label for="txtGioitinh">Giới tính</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtSdt" name="txtSdt" placeholder="Số điện thoại" />
                                                <label for="txtSdt">Số điện thoại</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtDiachi" name="txtDiachi" placeholder="Địa chỉ"></textarea>
                                                <label for="txtDiachi">Địa chỉ</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtNgaySinh" name="txtNgaySinh" placeholder="Ngày sinh" />
                                                <label for="txtNgaySinh">Ngày sinh</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtEmail" name="txtEmail" placeholder="Tên email" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <button class="btn btn-primary" type="submit">Thêm mới
                                                </button>
                                            </div>
                                        </form>
                                    </div>
