...
<body class="sb-nav-fixed">
    ...
    if ($anh_loai == NULL) {
        $sql = " UPDATE `loaisanpham` SET `tenloaisanpham` = '" . $ten_loai_san_pham . "' , parent_id = '" . $parent_id . "', level = '" . $level . "'
                WHERE `loaisanpham`.`maloaisanpham` = '" . $ma_loai_san_pham . "';
                ";
    } else {
        $sql = " UPDATE `loaisanpham` SET `tenloaisanpham` = '" . $ten_loai_san_pham . "', anhloai = '" . $anh_loai . "', parent_id = '" . $parent_id . "', level = '" . $level . "'
