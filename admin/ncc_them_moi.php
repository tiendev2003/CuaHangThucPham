                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Thêm mới nhà cung cấp</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="ncc_them_moi_thuc_hien.php" enctype="multipart/form-data">

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTenncc" name="txtTenncc" placeholder="Tên nhà cung cấp" />
