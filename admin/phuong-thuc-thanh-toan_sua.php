...
<body class="sb-nav-fixed">
        ...
        <?php
            ...
            $sql = "SELECT * 
                    ...
                    WHERE maphuongthucthanhtoan = '" .$id_pttt ."'
                    ";
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Cập nhật phương thức thanh toán</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="phuong-thuc-thanh-toan_sua_thuchien.php" >

                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputTitle" type="text" placeholder="Tên phương thức thanh toán" name="txtTenPTTT" value="<?php echo $row["tenphuongthucthanhtoan"]; ?>"/>
                                            <label for="inputTitle">Tên phương thức thanh toán</label>
                                        </div>
                                        
                                        <div class="mt-4 mb-0">
                                            <input type='hidden' name="txtID" value= "<?php echo $row['maphuongthucthanhtoan']; ?>" />
                                            <div class = "d-grid"><input class="btn btn-primary btn-block" type="submit" name="btnCapNhat" value = "Cập nhật"></div>
                                        </div>
                                </form>
                            </div>
                        </div>
