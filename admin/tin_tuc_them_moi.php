                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTieuDe" name="txtTieuDe" placeholder="Tiêu đề" />
                                                <label for="txtTieuDe">Tiêu đề</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtAnhMinhHoa" name="txtAnhMinhHoa" type="file" placeholder="Ảnh minh họa" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtNoiDung" name="txtNoiDung" placeholder="Nội dung"></textarea>
                                                <label for="txtNoiDung">Nội dung</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <button class="btn btn-primary" type="submit">Đăng bài
                                                </button>
                                            </div>
                                        </form>
                                    </div>
