...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        $sql = "
                       SELECT *
                       FROM loaisanpham
                       WHERE maloaisanpham = '" . $ma_loai_san_pham . "'  ;
             ";
        ...
        $row = mysqli_fetch_array($loai_san_pham);; ?>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Cập nhật loại sản phẩm</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="loaisanphamsuathuchien.php" enctype="multipart/form-data">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="txtTenLoaiSanPham" type="text" placeholder="Tên loại Sản Phẩm" name="txtTenLoaiSanPham" value="<?php echo $row["tenloaisanpham"]; ?>" />
                                            <label for="txtTenLoaiSanPham">Tên Loại Sản Phẩm</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input class="form-control" placeholder="Ảnh Loại" type="file" name="txtAnhLoai" id="txtAnhLoai" value="<?php echo $row["anhloai"]; ?>" />
                                            <label for="txtAnhLoai">Ảnh Loại</label>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label   mb-2" for="company">Loại sản phẩm cha</label>
                                            <div class="">
                                                <select id="company" class="form-control" name="txtParent">
                                                    <option value="" disabled selected>Có nếu bạn muốn thêm</option>
                                                    <?php
                                                    ...
                                                    $i = 0;
                                                    while ($row1 = mysqli_fetch_array($san_pham)) {
                                                        $i++;;
                                                        $selected = ($row1["maloaisanpham"] == $row["parent_id"]) ? 'selected' : '';
                                                        ?>
                                                        <option  value="<?php echo $row1["maloaisanpham"]; ?>" <?php echo $selected; ?>>
                                        ...
                                        <div class="form-group mt-2">
                                            <label class="control-label mb-2" for="company">Level</label>
                                            <div class="">
                                                <select id="company" class="form-control" name="txtLevel">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid">
                                                <input type="hidden" name="txtID" value="<?php echo $row["maloaisanpham"]; ?>">
