                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Cập nhật nhân viên</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="nhanvien_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTennv" name="txtTennv" placeholder="Tên nhân viên" value="<?php echo $row["hoten"]; ?>" />
                                                <label for="txtTennv">Tên nhân viên</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtGioitinh" name="txtGioitinh" placeholder="Giới tính" value="<?php echo $row["gioitinh"]; ?>"/>
                                                <label for="txtGioitinh">Giới tính</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtSdt" name="txtSdt" placeholder="Số điện thoại" value="<?php echo $row["sdt"]; ?>" />
                                                <label for="txtSdt">Số điện thoại</label>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="txtDiachi" name="txtDiachi" placeholder="Địa chỉ"><?php echo $row["quequan"]; ?></textarea>
                                                <label for="txtDiachi">Địa chỉ</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtNgaySinh" name="txtNgaySinh" placeholder="Tên nhà cung cấp" value="<?php echo $row["ngaysinh"]; ?>" />
                                                <label for="txtNgaySinh">Ngày sinh</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["manhanvien"]; ?>">
