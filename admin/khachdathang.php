        ...
        <div id="layoutSidenav_nav" >
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị khách đặt hàng</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách khách đặt hàng | Chuyển sang trang <a href="khachhang.php">Danh sách khách hàng</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        $sql = "
                                                  SELECT *
                                                  FROM khachdathang
                                                  ORDER BY makhachdathang DESC 
                                        ";
                                        // 3. Thực thi câu lệnh lấy dữ liệu mong muốn
                                        $khach_dat_hang= mysqli_query($ket_noi, $sql);
                                        // 4. Hiển thị ra dữ liệu mà các bạn vừa lấy
                                        $i=0;
                                        while ($row = mysqli_fetch_array($khach_dat_hang)) {
                                            $i++;
                                    ;?>
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $row["makhachdathang"];?></td>
                                            <td><?php echo $row["tenkhachdathang"];?></td>
                                            <td><?php echo $row["diachikhachdathang"];?></td>
                                            <td><?php echo $row["emailkhachdathang"];?></td>
                                            <td><?php echo $row["sodienthoaikhachdathang"];?></td>                                            
                                        </tr>
                                    <?php
                                        }
                                    ;?>
