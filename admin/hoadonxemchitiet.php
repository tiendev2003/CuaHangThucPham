                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="hoadon.php">Danh sách hóa đơn</a> | <a href="hoadonxemchitiet.php">Xem hóa đơn chi tiết</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        $hoa_don_chi_tiet = mysqli_query($ket_noi, $sql) or die("lỗi truy vấn");

                                        // 4. Hiển thị ra dữ liệu mà các bạn vừa lấy
                                        while($row = mysqli_fetch_array($hoa_don_chi_tiet)){
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td><?php echo $row["maphuongthucthanhtoan"];?></td>
