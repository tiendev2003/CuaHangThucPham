                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Thêm mới phương thức thanh toán</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="phuong-thuc-thanh-toan_themmoi_thuchien.php" >

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputTitle" type="text" placeholder="Tên phương thức thanh toán" name="txtTenPTTT"/>
