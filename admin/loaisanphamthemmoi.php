                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Thêm loại sản phẩm</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="loaisanphamthemmoithuchien.php" enctype="multipart/form-data">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="txtTenLoaiSanPham" type="text" placeholder="Tên loại Sản Phẩm" name="txtTenLoaiSanPham" />
                                            <label for="txtTenLoaiSanPham">Tên Loại Sản Phẩm</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input class="form-control" placeholder="Ảnh Loại" type="file" name="txtAnhLoai" id="txtAnhLoai" />
