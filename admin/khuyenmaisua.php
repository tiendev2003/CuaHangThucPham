        ...
        <div id="layoutSidenav_nav" >
            ...
            <?php
             ...
             $sql = "
                       SELECT *
                       FROM khuyenmai
                       WHERE makhuyenmai= '".$ma_khuyen_mai."'  ;
             ";
 
             // 3. Thực thi câu lệnh lấy dữ liệu mong muốn
             $khuyen_mai= mysqli_query($ket_noi, $sql);
 
                // 4. Hiển thị ra dữ liệu mà các bạn vừa lấy
                $row = mysqli_fetch_array($khuyen_mai);
            ;?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cập nhật khuyến mãi</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="khuyenmaisuathuchien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" placeholder="Giảm giá"  type="text" name="txtGiamGia" id="txtGiamGia"  value="<?php echo $row["giamgia"];?>" />                                              
                                                <label for="txtGiamGia">Giảm giá</label>
                                            </div> 
                                            <div class="form-floating mb-3">
                                                <input class="form-control" placeholder="Thời hạn"  type="text" name="txtThoiHan" id="txtThoiHan"  value="<?php echo $row["thoihan"];?>" />                                              
                                                <label for="txtThoiHan">Thời hạn</label>
                                            </div>                                         
                                            <div class="mt-4 mb-0">     
                                                <div class="d-grid">   
                                                    <input type="hidden" name="txtID" value="<?php echo $row["makhuyenmai"];?>">
