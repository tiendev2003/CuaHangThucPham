        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Quản trị khuyến mãi</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Danh sách khuyến mãi| <a href="khuyenmaithemmoi.php">Thêm mới</a>
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    while ($row = mysqli_fetch_array($khuyen_mai)) {
                                        $i++;; ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            ...
                                            <td><a href="khuyenmaisua.php?id=<?php echo $row["makhuyenmai"]; ?>">Sửa</a></td>
                                            <td><a href="khuyenmaixoa.php?id=<?php echo $row["makhuyenmai"]; ?>">Xóa</a></td>
                                        </tr>
                                    <?php
                                    }; ?>
                                </tbody>
