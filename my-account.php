                          ...
                          ";
                                            ...
                                            while ($row = mysqli_fetch_array($khachhang)) {; ?>
                                                ...
                                                <form action="alter-info.php" method="post">
                                                    <div class="account-details">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-box__single-group">
                                                                    <button class="btn btn--box btn--radius btn--small btn--black btn--black-hover-green btn--uppercase font--bold" name="Makhachhang" value="<?php echo $row["makhachhang"]; ?>">Thay đổi thông tin</button>
                                                                </div>
                                                            </div>
                                                </form>
                                                ...
                                                <form action="alter-password.php" method="post">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-box__single-group">
                                                            <button class="btn btn--box btn--radius btn--small btn--black btn--black-hover-green btn--uppercase font--bold" name="Makhachhang" value="<?php echo $row["makhachhang"]; ?>">Lưu thay đổi</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php }; ?>
