...
<body>
                ...
                <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($cart as $key => $row) : ?>
                                    ...
                                    <div class="cart-items">
                                        ...
                                        <tr class="gray-bg">
                                            <div class="cart-row">
                                                <td class="product-subtotal stt"><?php echo (int)$i++; ?></td>
                                                <td class="product-thumbnail">
                                                    <a href="#"><img class="img-fluid" src="./assets/img/product/size-normal/<?php echo $row['anh'] ?>" alt=""></a>
                                                </td>
                                                <td class="product-name"><a href="#"><?php echo $row['tensanpham']; ?></a></td>
                                                <td class="product-price-cart"> <span class="amount"><?php echo $row['dongia']; ?> VND</span>
                                                <td class="product-thumbnail"><a href="#"><?php echo $row['soluong']; ?></a></td>
                                                <td class="product-quantities">
                                                    <div class="quantity d-inline-block" onclick="updateCart(<?php echo $row['masanpham'] ?>)" id="quantyti">
                                                        <input class="cart-quantity-input" id="num_<?php echo $row['masanpham'] ?>" type="number" min="1" step="1" value="<?php echo $row['soluongmua']; ?>">
                                                    </div>
                                                </td>
                                                ...
                                                <td class="product-remove">
                                                    <button onclick="deleteCart(<?php echo $row['masanpham'] ?>)" class="btn-danger" type="button">Xóa</button>
                                                </td>
                                            </div>
                                        </tr>
                    ...
                    <div class="cart-table-button m-t-10">
                        <div class="cart-table-button--left">
                            <a href="shop.php" class="btn btn--box btn--large btn--radius btn--green btn--green-hover-black btn--uppercase font--bold m-t-20">Tiếp Tục Mua Sắm</a>
                        </div>
                        <div class="cart-table-button--right">
                            <a href="#" onclick="deleteCartFull()" class="btn btn--box btn--large btn--radius btn--black btn--black-hover-green btn--uppercase font--bold m-t-20">Xóa Giỏ Hàng</a>
                            <button class="" type="submit"><a href="checkout.php" class="btn btn--box btn--large btn--radius btn--green btn--green-hover-black btn--uppercase font--bold m-t-20">Thanh toán</a></button>
                        </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function deleteCartFull() {
            $.post("updateCart.php", {}, function(data, status) {
                location.reload();
            });
        }
    </script>
