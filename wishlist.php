...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Danh sách sản phẩm yêu thích</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-content">
                        <h5 class="section-content__title">Sản phẩm yêu thích của bạn</h5>
                    </div>
                    ...
                    <div class="table-content table-responsive cart-table-content m-t-30">
                                        ...
                                        <tr class="gray-bg" >
                                            <div class="cart-row">
                                                ...
                                                <td class="product-remove">                                                                                                 
                                                    <button onclick="deletewishlist(<?php echo $row['masanpham']?>)" class="btn-danger" type="button">Xóa</button>                                                                                    
                                                </td>
                                                <td class="product-add-cart">
                                                    <?php 
                                                    if($row["soluong"]!=0){
                                                        echo '
                                                            <a href="#" onclick="addCart('.$row['masanpham'].')" id="'.$row['masanpham'].'" class="btn btn--small btn--radius-tiny btn--green btn--green-hover-black">Thêm vào giỏ</a>
                                                        ';
                                                    }
                                                    else {
                                                        echo '<a href="#" class="btn btn--small btn--radius-tiny btn--green btn--green-hover-black">Tạm hết hàng</a>';
                                                    }
                                                    ?>
                                                </td>
                                            </div>
                       ...
                       <div class="cart-table-button m-t-10">
                           <div class="cart-table-button--left">
                               <a href="shop.php" class="btn btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--bold m-t-20">Tiếp Tục Mua Sắm</a>
                           </div>
                           <div class="cart-table-button--right">
                               <a href="#" onclick="deleteWishListFull()" class="btn btn--small btn--radius btn--black btn--black-hover-green m-t-20">Xóa hết danh sách yêu thích</a>
                           </div>
                       </div>  
    ...
    <script>
        ...
        function deletewishlist(id){
            // xóa từng mặt hàng yêu thích
            // alert(id);
            $.post("updateWishList.php",{'id':id}, function(data, status){
                // load lại trang để cập nhật
                location.reload();
            });
        }

        function deleteWishListFull(){
            $.post("updateWishList.php",{}, function(data, status){
                location.reload();
            });
        }
    </script>
