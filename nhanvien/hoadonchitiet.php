                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Danh sách hóa đơn | <a href="hoadonchitiet.php">Hóa đơn chi tiết</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($san_pham)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="sanphamsua.php?id=<?php echo $row["masanpham"]; ?>">Sửa</a></td>
                                            <td><a href="sanphamxoa.php?id=<?php echo $row["masanpham"]; ?>">Xóa</a></td>
                                        </tr>
                                    <?php
                                    }; ?>
                                </tbody>
