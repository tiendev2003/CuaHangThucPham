                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["chudelienhe"] ?></td>
                                            ...
                                            <td>
                                                <select name="select-status" class="select-status" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                    <option value="lien-he_sua-trang-thai.php?id=<?php echo $row['malienhe'] ?>&status=1" <?php if ($row["trangthai"] == 1) echo "selected"; ?>>Đã xử lý</option>
                                                    <option value="lien-he_sua-trang-thai.php?id=<?php echo $row['malienhe'] ?>&status=0" <?php if ($row["trangthai"] == 0) echo "selected"; ?>>Chưa xử lý</option>
                                                </select>
                                            </td>
