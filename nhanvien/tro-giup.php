        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Quản trị trợ giúp</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.php">Bảng điều khiển</a></li>
                        <li class="breadcrumb-item active">Quản trị trợ giúp</li>
                    </ol>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row["tentrogiup"] ?></td>
                                            <td><?php echo $row["emailtrogiup"] ?></td>
                                            <td><?php echo $row["sdttrogiup"] ?></td>
                                            <td><?php echo $row["noidungtrogiup"] ?></td>
                                            ...
                                            <td>
                                                <select name="select-status" class="select-status" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                    <option value="tro-giup_sua-trang-thai.php?id=<?php echo $row['matrogiup'] ?>&status=1" <?php if ($row["trangthai"] == 1) echo "selected"; ?>>Đã xử lý</option>
                                                    <option value="tro-giup_sua-trang-thai.php?id=<?php echo $row['matrogiup'] ?>&status=0" <?php if ($row["trangthai"] == 0) echo "selected"; ?>>Chưa xử lý</option>
                                                </select>
                                            </td>
