            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-content m-b-40">
                        <h5 class="section-content__title text-center">TÀI KHOẢN</h5>
                    </div>
                </div>
                <!-- Start Login Area -->
                <div class="col-lg-6 col-12">
                    <div class="login-form-container">
                        ...
                        <div class="login-register-form">
                            <form name="f1" action="login-check.php" method="post">
                                <div class="form-box__single-group">
                                    <label for="form-username">Email *</label>
                                    <input type="text" id="form-username" placeholder="Nhập email" name="Email" required>
                                </div>
                                <div class="form-box__single-group">
                                    <label for="form-username-password">Mật khẩu *</label>
                                    <div class="password__toggle">
                                        <input type="password" id="form-username-password" placeholder="Nhập mật khẩu" name="Matkhau" required>
                                ...
                                <div class="d-flex justify-content-between flex-wrap m-tb-20">
                                    ...
                                    <a class="link--gray" href="contact.php">Quên mật khẩu?</a>
                                </div>
                                <button class="btn btn--box btn--medium btn--radius btn--black btn--black-hover-green btn--uppercase font--semi-bold" type="submit">ĐĂNG NHẬP</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="login-register-form">
                            <form action="register-check.php" method="post">
                                <div class="form-box__single-group">
                                    ...
                                    <input type="email" id="form-uregister-sername-email" name="regEmail" placeholder="Nhập email" required>
                                </div>
                                <div class="form-box__single-group m-b-20">
                                    <label for="form-register-username-password">Mật khẩu *</label>
                                    <div class="password__toggle">
                                        <input type="password" id="form-register-username-password" name="regMatkhau" placeholder="Nhập mật khẩu" required>
                                        <span data-bs-toggle="#form-register-username-password" class="password__toggle--btn fa fa-fw fa-eye"></span>
                                    </div>
                                </div>
                                <div class="form-box__single-group">
                                    <label >Họ tên</label>
                                    <input placeholder="Nhập họ tên" name="regHoten">
                                </div>
                                <div class="form-box__single-group">
                                    <label >Địa chỉ</label>
                                    <input placeholder="Nhập địa chỉ" name="regDiachi">
                                </div>
                                <div class="form-box__single-group">
                                    <label >Số điện thoại</label>
                                    <input placeholder="Nhập số điện thoại" name="regSdt">
                                </div>
                                <div><br></div>
