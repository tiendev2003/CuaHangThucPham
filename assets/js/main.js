(function ($) {
    ...
    if ($lis.length > 0) {
      $ul.append(
        $(
          '<li class="expand">' +
            (isExpanded
              ? '<a href="javascript:;"><div><i class="icon-minus-square"></i>Close Categories</div></a>'
              : '<a href="javascript:;"><div><i class="icon-plus-square"></i>More Categories</div></a>') +
            "</li>"
  ...
  $(".product-default-slider-4grid-2rows").slick({
    ...
    speed: 1000,
    prevArrow:
      '<button type="button" class="default-slider__arrow default-slider__arrow--left prevArrow"><i class="far fa-chevron-left"></i></i></button>',
    nextArrow:
      '<button type="button"  class="default-slider__arrow default-slider__arrow--right nextArrow"><i class="far fa-chevron-right"></i></button>',
    responsive: [
      {
        breakpoint: 1200,
        settings: {
  ...
  $(".product-image--thumb-horizontal").slick({
    ...
    focusOnSelect: true,
    prevArrow:
      '<button type="button" class="gallery__nav gallery__nav-horizontal gallery__nav-horizontal--left prevArrow"><i class="fas fa-chevron-left"></i></button>',
    nextArrow:
      '<button type="button"  class="gallery__nav gallery__nav-horizontal gallery__nav-horizontal--right nextArrow"><i class="fas fa-chevron-right"></i></button>',
  });
  /***********************************
   * Gallery - Vertical
   ************************************/
  ...
  $(".product-image--thumb-vertical").slick({
    ...
    focusOnSelect: true,
    prevArrow:
      '<button type="button" class="gallery__nav gallery__nav-vertical gallery__nav-vertical--up prevArrow"><i class="fas fa-chevron-up"></i></button>',
    nextArrow:
      '<button type="button"  class="gallery__nav gallery__nav-vertical gallery__nav-vertical--down nextArrow"><i class="fas fa-chevron-down"></i></button>',
  });
  ...
  $(".inner-slider-grid-1").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" class="inner-slider__arrow inner-slider__arrow--left prevArrow"><i class="far fa-chevron-left"></i></button>',
    nextArrow:
      '<button type="button"  class="inner-slider__arrow inner-slider__arrow--right nextArrow"><i class="far fa-chevron-right"></i></button>',
  });
  ...
  $("[data-countdown]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="cdown day">%-D <p>Ngày</p></div> <div class="cdown hour">%-H <p>Giờ</p></div> <div class="cdown minutes">%M <p>Phút</p></div> <div class="cdown second">%S <p>Giây</p></div>'
        )
      );
    });
  });
