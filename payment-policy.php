            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active"> Chính sách đổi trả</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="col-12">
                        <div class="section-content m-b-60 text-center">
                            <h5 class="section-content__title">Chính sách đổi trả</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="privacy-policy-section">
                        <div class="text-area">
                            <p class="font--bold">Dễ dàng và miễn phí, trong vòng 9 ngày</p>
